...
<div class="primary-sidebar">
	...
	<ul class="nav nav-collapse collapse nav-collapse-primary">
        ...
        <li class="<?php if($page_name == 'visit_details')echo 'dark-nav active';?>">
			<span class="glow"></span>
				<a href="<?php echo base_url();?>index.php?patient/visit_details" >
					<i class="icon-calendar icon-2x"></i>
					<span><?php echo get_phrase('patient visit details');?></span>
				</a>
		</li>
        <!-- end of pre appointment information -->
        ...
        <!--antenatal -->
        <li class="<?php if($page_name == 'antenatal')echo 'dark-nav active';?>">
			<span class="glow"></span>
				<a href="<?php echo base_url();?>index.php?patient/antenatal" >
					<i class="icon-stethoscope icon-2x"></i>
					<span><?php echo get_phrase('antenatal_registration');?></span>
				</a>
		</li>
