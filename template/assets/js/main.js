...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		//$('#skin_color').attr("href", "http://"+location.hostname+"/realhospitaldesign/template/assets/css/themes/" + appSetting.theme + ".css");
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				default:
					//$(".navbar-brand img").attr("src", "../te/assets/images/logo.png");
					break;
			};
		};
